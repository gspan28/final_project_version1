...
Using the Kaggle CSV files, I have successfully imported the business overview data into R, which includes restaurant ratings. This week, I browsed through the other CSV files and determined which ones would be most useful to me. 2 files, yelp_tip and yelp_review will be useful because they will allow me to complete the second step of my project, detecting strings of keywords relevant to date spots.
